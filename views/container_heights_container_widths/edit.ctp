...
<?php echo $this->Form->create('ContainerHeightsContainerWidth');?>
	<fieldset>
		<legend><?php __('Edit Container Heights Container Width'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ContainerHeightsContainerWidth.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ContainerHeightsContainerWidth.id'))); ?></li>
