...
<?php echo $this->Form->create('ContainerType');?>
	<fieldset>
		<legend><?php __('Edit Container Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ContainerType.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ContainerType.id'))); ?></li>
