<div class="rows index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $row['Row']['code']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $row['Row']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $row['Row']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $row['Row']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $row['Row']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
